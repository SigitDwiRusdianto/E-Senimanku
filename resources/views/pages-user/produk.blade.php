    ...
    <div id="drawer-example" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label">
        ...
        <div class="divide-y divide-gray-200 space-y-5">
            <form action="{{route('filter_produk')}}" method="post">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center">
                            <input type="checkbox" name="jenis[]" id="cat-1" value="Mobile" class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                            <label for="cat-1" class="text-gray-600 ml-3 cusror-pointer">Mobile Design</label>
                            <div class="ml-auto text-gray-600 text-sm">({{$total_mobile}})</div>
                        </div>
                        
                        <div class="flex items-center">
                            <input type="checkbox" name="jenis[]" id="cat-2" value="Logo" class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                            <label for="cat-2" class="text-gray-600 ml-3 cusror-pointer">Logo Design</label>
                            <div class="ml-auto text-gray-600 text-sm">({{$total_logo}})</div>
                        </div>

                        <div class="flex items-center">
                            <input type="checkbox" name="jenis[]" id="cat-2" value="Website" class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                            <label for="cat-2" class="text-gray-600 ml-3 cusror-pointer">Website Design</label>
                            <div class="ml-auto text-gray-600 text-sm">({{$total_website}})</div>
                        </div>
                ...
                <div class="pt-4">
                    <h3 class="text-xl text-gray-800 mb-3 uppercase font-medium">Desainer</h3>
                    <div class="space-y-2">
                ...
                <button type="submit" class="block w-full py-1 text-center text-white bg-blue-600 border border-primary rounded-md">Filter</button>
        </div>
        </form>
    </div>
        ...
        <form action="{{route('filter_produk')}}" method="post">
            ...
            <div class="divide-y divide-gray-200 space-y-5">
                <div>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center">
                            <input type="checkbox" name="jenis_mobile[]" id="cat-1" value="Mobile" class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                            <label for="cat-1" class="text-gray-600 ml-3 cusror-pointer">Mobile Design</label>
                            <div class="ml-auto text-gray-600 text-sm">({{$total_mobile}})</div>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="jenis_mobile[]" id="cat-2" value="Logo" class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                            <label for="cat-2" class="text-gray-600 ml-3 cusror-pointer">Logo Design</label>
                            <div class="ml-auto text-gray-600 text-sm">({{$total_logo}})</div>
                        </div>

                        <div class="flex items-center">
                            <input type="checkbox" name="jenis_mobile[]" id="cat-2" value="Website" class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                            <label for="cat-2" class="text-gray-600 ml-3 cusror-pointer">Website Design</label>
                            <div class="ml-auto text-gray-600 text-sm">({{$total_website}})</div>
                        </div>
                    </div>
    ...
    <div class="col-span-3">
        <div class="flex items-center mb-4">
            <div class="flex ">
                <div class="text-center md:hidden">
                    <button class="text-white hover:bg-blue-600 bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-800 block md:hidden" type="button" data-drawer-target="drawer-example" data-drawer-show="drawer-example" aria-controls="drawer-example">
        ...
        <div class="grid md:grid-cols-3 grid-cols-2 gap-6">
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                @if($data->stok != 0)
                <a href="{{route('pesanan-create',$data->id)}}" class="block w-full py-1 text-center text-white bg-blue-600 border border-primary rounded-b hover:bg-transparent hover:text-primary transition">Hire</a>
                @else
                <button disabled class="block w-full py-1 text-center text-white bg-blue-300 border border-blue-300 rounded-b ">Hire</button>
                @endif
            </div>
            @endforeach
        </div>
