            ...
            <div class="card-body">
                <form method="POST" action="{{ route('profile-update',$user->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        @else
                        <label for="exampleInputNama">Nama Toko</label>
                        @endif
                    ...
                    @if(Auth::user()->role == 'Penjual')
                    <div class="form-group">
                        <label for="exampleInputDeskripsiBarang">Deskripsi Toko</label>
                        <textarea class="form-control" id="exampleInputDeskripsiBarang" rows="4" placeholder="Input Deskripsi Toko" name="deskripsi_toko">{{$user->penjual->deskripsi_toko}}</textarea>
                    </div>
                    @endif
                    <div class="form-group">
